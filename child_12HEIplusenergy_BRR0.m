...
diary('Output/child_12HEIplusenergy_BRR0.txt');
...
Sigmae_thin_trace = Sigmae_thin_trace .* (abs(Sigmae_thin_trace) > eps);
    ...
    save Output/child_Sigmau_mean.mat Sigmau_mean_trace;
    save Output/child_Sigmae_mean.mat Sigmae_mean_trace;
    save Output/child_beta_mean.mat   beta_mean_trace;   

    save Output/child_Sigmau.mat Sigmau_thin_trace;
    save Output/child_Sigmae.mat Sigmae_thin_trace;
    save Output/child_beta.mat   beta_thin_trace;   
...
load Output/child_Sigmae.mat Sigmae_thin_trace;
load Output/child_Sigmau.mat Sigmau_thin_trace;
load Output/child_beta.mat beta_thin_trace;
...
% end;
 ...
 energy = TT_reorder(:,13,:);
   ...
   format bank;
   R = floor(100 .* (R+0.001)) ./ 100
   save Output/adjustedintake_R.txt R -ascii;
   for  i= 1:12;
...
save Output/quantiles_Usual_Intakes.mat q3;
...
save Output/quantiles_Usual_Densities.mat q3;
 ...
 R
 save Output/score_R_model.mat R;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save Output/quantiles_Usual_HEI_Scores.mat q3;

save Output/q3.mat q3;
 for j = 1:13;
...
save Output/q4_gt50.mat q4;
for j =[2,4,6,12];
disp(['&',num2str(q4(100,j)),'&',num2str(q4(101,j)),'&', num2str(q4(5,j)),'&',num2str(q4(10,j)),'&',num2str(q4(25,j)),'&',num2str(q4(50,j)),'&',num2str(q4(75,j)),'&',num2str(q4(90,j)), '&',num2str(q4(95,j)),'\\']);
end;

%Figure 2 in paper
load Output/q4_lt50.mat q4;
q4lt50=q4;
load Output/q4_gt50.mat q4;
q4gt50=q4;
p = linspace(0.01,0.99,99);
